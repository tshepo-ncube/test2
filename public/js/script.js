...
function makeMaze() {
  ...
  console.log('Sending difficulty.')
  socket.emit('sendDifficulty', difficulty);
  console.log('Sending difficulty.')

  // maze = new Maze(difficulty, difficulty); // This is run on server and reterned by socket

  socket.on('mazeBroadcast', (maze) => {
    console.log('Maze broadcast received');
